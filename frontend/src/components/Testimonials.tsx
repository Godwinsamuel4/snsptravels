...
const testimonials = [
  {
    ...
    text: "SN.SP Limited made my family vacation to Dubai absolutely seamless. From flight booking to hotel reservations, everything was perfect!",
    rating: 5
  },
  {
    name: "Fatima Ahmed",
    location: "Abuja, Nigeria",
    text: "Their visa application service was exceptional. They guided me through every step and I got my UK visa approved quickly.",
    rating: 5
  },
  {
    name: "Michael Okonkwo",
    location: "Port Harcourt, Nigeria",
    text: "Professional and reliable service. They helped me with my study abroad application to Canada. Highly recommended!",
    rating: 5
  }
];
